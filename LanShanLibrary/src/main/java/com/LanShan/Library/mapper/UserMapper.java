...
public interface UserMapper {
    ...
    @Insert("INSERT INTO users (id, username, password, authority,enabled,introduction,max_borrow) VALUES (#{id}, #{username}, #{password}, #{authority},#{enabled},'这个人很懒，什么都没写',#{max_borrow})")
    public Integer addUser(String id, String username, String password, String authority, boolean enabled,Integer max_borrow);
