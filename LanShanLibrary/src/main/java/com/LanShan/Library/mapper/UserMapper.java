...
public interface UserMapper {
    ...
    @Select("select id,username,authority,introduction,enabled from users")
    ...
    @Insert("INSERT into library.comments (aim_id,user_id,content,created_at,id) values (#{aim_id},#{user_id},#{content},#{time},#{id})")
    ...
    public void addBook(String id, String name, String author, String ISBN, String publishedDate, String label, String publisher,Integer num);
