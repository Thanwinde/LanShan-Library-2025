...
@Component  // 该类会被Spring管理为Bean，作为服务层类使用
public class JWTService {

    private String jwtSigningKey = "413F4428472B4B6250655368566D5970337336763979244226452948404D6351";  // JWT签名密钥（实际使用时要更安全）

    // 提取JWT中的用户名（通常是邮箱或者用户标识）
    ...
    public String generateToken(UserDetails userDetails) {
        return generateToken(new HashMap<>(), userDetails);  // 默认没有额外的自定义信息
    }
