...
**蓝山图书馆管理系统** ， ~~其实看到这个任务时有点南蚌~~ 

* 使用了SSM来构造项目

* 采用了Spring Security作为框架，Session来实现认证及持久化访问,具有csrf防御并启用了cors
...
![image-20250130194214095](assets/image-20250130194214095.png)
...
* pojo一定不能省，比如不能用简单粗暴的 **ImmutablePair<Object,Long>**这种类型的返回值而不专门做个pojo会导致想拓展及维护很困难
