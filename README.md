...
2025.2.15第十四次更新，在图书统计页面加上了最新、评分最高、借阅最多、评论最多、借阅最多的用户的数据；

加上了订阅功能：当用户用邮箱注册或绑定了邮箱后会每天发送一封推荐图书的邮件，推荐系统同与api中的一致

**目前由于QQ邮箱因为邮件发送过多被禁用，邮件相关服务暂时无法使用**
**2025.2.17已更换邮箱，可正常使用**
